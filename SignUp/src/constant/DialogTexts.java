...
public class DialogTexts {
    ...
    public static final String ADDRESS_COMPLETE = "ADDRESS COMPLETE";
    public static final String LOGIN_FAIL = "LOG IN Fail!";
    public static final String FAIL = "FAIL";
    public static final String COMPLETE = "COMPLETE";
    public static final String REQUEST_INPUT_ALL = "Please Input your Information";
    public static final String REQUEST_INPUT = "Please Available your %s";
    public static final String REQUEST_DUPLICATION_BUTTON = "Please Check duplication";
